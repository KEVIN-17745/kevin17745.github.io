...
<div class="alert alert-success" role="alert" style= "background:#f2dfd0;">
      ...
      <div class="row s_product_inner justify-content-between">
        <div class="col-lg-7 col-xl-7">
          <div class="product_slider_img">
            <div id="vertical">
              ...
              <?php $product_image_path = 'images/product_images/medium/'.$productDetails['main_image']; ?>
                            @if(!empty($productDetails['main_image']) && file_exists($product_image_path))
                        
                            <img src="{{asset('images/product_images/medium/'.$productDetails['main_image'])}}" alt="">
        ...
        <div class="col-lg-5 col-xl-4">
          ...
          <div class="s_product_text">
            ...
            <h2>Rs.{{$productDetails->product_price}}</h2>
            <ul class="list">
            ...
            <div class="card_area d-flex justify-content-between align-items-center">
              ...
              <a href="{{url('/checkout')}}" class="genric-btn primary circle">Buy now</a>
            </div>
            ...
            <table class="table">
              <tbody>
                <tr>
                  ...
                  <td>
                    <h5>{{$productDetails->product_diamensions}}</h5>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <h5>{{$productDetails->product_color}}</h5>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <h5>{{$productDetails->product_material}}</h5>
                  </td>
                </tr>
